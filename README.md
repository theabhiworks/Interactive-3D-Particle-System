...
Built with Three.js + AI + Hand Tracking

This project is a real-time interactive 3D particle system powered by Three.js, gesture recognition, and modern browser APIs.
You can control particle behavior using hand gestures through your camera — expansion, color shifts, particle shape transitions, and more.
...
🎆 Multiple particle templates: hearts, flowers, Saturn, fireworks, and more

🔄 Real-time particle transformations

⚡ Smooth 3D rendering using WebGL + Three.js

📁 All in a single file (HTML + JS + CSS inline)
